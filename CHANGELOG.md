...
## [Unreleased](https://github.com/craft-ai/craft-ai-client-js/compare/v1.19.1...HEAD) ##

### Added ###

- Add support for generators bulk with `client` methods `createGeneratorBulk`, `deleteGeneratorBulk` and `getGeneratorDecisionTreeBulk`.
