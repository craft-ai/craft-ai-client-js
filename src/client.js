  ...
  let instance = {
    ...
    getAgentContextOperations: function(
      ...
      const requestFollowingPages = ({ operations, nextPageUrl }) => {
        ...
        return request({ url: nextPageUrl }, this).then(
          ({ body, nextPageUrl }) =>
    ...
    getAgentStateHistory: function(
      ...
      const requestFollowingPages = ({ stateHistory, nextPageUrl }) => {
        ...
        return request({ url: nextPageUrl }).then(({ body, nextPageUrl }) =>
          requestFollowingPages({
    ...
    getAgentDecisionTree: function(
      ...
      if (!cfg.decisionTreeRetrievalTimeout) {
        ...
        return Promise.race([
          agentDecisionTreeRequest().catch((error) => {
            ...
            if (
              ...
              return resolveAfterTimeout(timeoutBeforeRetrying).then(() =>
          ...
          resolveAfterTimeout(cfg.decisionTreeRetrievalTimeout).then(() => {
